...
def write_mole_fractions(dacycle):
    ...
    infiles = infiles1
    for i, ii in enumerate(infiles):
        infiles[i] = ii.replace("!", "")
#    if d1 == d2:
#        infiles = infiles1
#    else:
#        infiles = []
  ...
  #  sys.exit()
    for orig_file in set(infiles):
        ...
        if not os.path.exists(copy_file):
            ...
            if 'time' in ncf_out.dimensions:
                dimidob = ncf_out.dimensions['time']
                dimid = ('time',)
...
#        sys.exit()
  #      print(infiles)
   #     sys.exit()
    ...
    #    print('AAAAAAAAAAAAAAAAAAAAAAAAAAAAA', selected_obs_nums)
...
if __name__ == "__main__":
    ...
    dacycle = CycleControl(args={'rc':'/store/empa/em05/parsenov/CTDAS/ctdas-cosmo/config.rc'})
    dasystem = CO2DaSystem('/store/empa/em05/parsenov/CTDAS/ctdas-cosmo/da/rc/carbontracker_cosmo.rc')
