...
#
        ...
        bio = np.array(file.get_variable(dacycle.dasystem['CO2_BG001']))
        ocean = np.array(file.get_variable(dacycle.dasystem['CO2_GPP001']))
        fire = np.array(file.get_variable(dacycle.dasystem['CO2_RA001']))
