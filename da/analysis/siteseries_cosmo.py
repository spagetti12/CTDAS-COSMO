...
import logging
import copy
from da.analysis.summarize_obs_cosmo import nice_lon, nice_lat, nice_alt
...
#        molefac=1e6
 #       units = '$\mu$mol mol$^{-1}$'
    ...
    try:
        img = urlopen('http://www.esrl.noaa.gov/gmd/webdata/ccgg/ObsPack/images/logos/'+SDSInfo['lab_1_logo']).read()
    except:
...
if __name__ == '__main__':    # started as script
    ...
    analysisdir = "/scratch/snx3000/parsenov/real/analysis"
